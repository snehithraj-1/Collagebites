      ...
      <div className="relative w-full max-w-sm sm:max-w-md bg-[#0F172A] border-l border-slate-800 text-slate-100 shadow-2xl flex flex-col h-full z-10 animate-drawer-right overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-5 sm:p-6 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <a
              href={typeof window !== 'undefined' && window.location.hostname === 'clg-bites-srm.vercel.app' ? '/#delivery' : 'https://clg-bites-srm.vercel.app/#delivery'}
              target="_blank"
            ...
            {/* Live Student Portal Link */}
            <a
              href={typeof window !== 'undefined' && window.location.hostname === 'clg-bites-srm.vercel.app' ? '/' : 'https://clg-bites-srm.vercel.app'}
              target="_blank"
              rel="noopener noreferrer"
              className="w-full p-3.5 rounded-2xl bg-slate-900/90 hover:bg-emerald-950/40 border border-slate-800 hover:border-emerald-500/40 text-left transition-all cursor-pointer flex items-center justify-between group active:scale-[0.98] no-underline"
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400">
                    Live food ordering interface
                  </p>
                </div>
              </div>
              <ExternalLink size={15} className="text-slate-500 group-hover:text-emerald-400 transition-all" />
            </a>
          </div>
